...
const columns: Column<TenantRow>[] = [
  ...
  { key: 'seats', header: 'Seats', align: 'right', cell: (r) => r.seats.toLocaleString() },
  {
    ...
    header: 'MRR',
    align: 'right',
    cell: (r) => <span className="font-mono">{money(r.mrr)}</span>,
  },
  {
    key: 'growth',
    header: 'Growth',
